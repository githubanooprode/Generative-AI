...
create_main() { # create_main IMAGE_FILE SETTINGS_FILE
    ...
    echo "ImageInpainting_Main_Simplified_2017(struct('machine', '$h', 'theImage', '`basename $1`','imagePath','$remote_base_dir/$image_dir/','resultsDir','$result_dir',  'logfile', '$remote_base_dir/$result_dir/$resultname.log' $settings)); quit()"
